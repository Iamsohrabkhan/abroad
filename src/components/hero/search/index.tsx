...
console.log("hello");
  ...
  return (
    <div
      ref={container}
      className="relative lg:my-12 overflow-hidden lg:overflow-visible"
    >
      <div
        className={`lg:rounded-full max-w-84 lg:max-w-none flex lg:flex-row flex-col duration-300 -space-x-2 transition-all ease-out [&_input]:cursor-pointer ${
